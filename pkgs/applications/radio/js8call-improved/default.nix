...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    sha256 = "sha256-dpPh3+s29ksdVGc1I5JOJrqzS51Bda8afgU5RrO6B3w=";
  };
  ...
  installPhase = ''
    mkdir -p $out/bin $out/share/doc/js8call $out/icons/hicolor/128x128/apps $out/share/applications
    cp JS8Call $out/bin
    cp ../LICENSE ../README.md $out/share/doc/js8call
    cp ../artwork/js8call_icon.png $out/icons/hicolor/128x128/apps
